...
public interface ITransactionService
{
    ...
    Task<FileProcessorResponseDto> ParseCsvFile(AccountModel account, Stream file);
    Task<FileProcessorResponseDto> ProcessCsvFile(AccountModel account, Stream file);
